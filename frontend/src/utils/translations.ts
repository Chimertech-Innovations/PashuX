...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
  ...
  ta: {
    ...
    nav_history: 'வரலாறு',
    nav_products: 'கால்நடை பொருட்கள்',
    nav_admin: 'நிர்வாகி போர்ட்டல்',
    nav_signin: 'உள்நுழை',
  ...
  kn: {
    ...
    nav_history: 'ಇತಿಹಾಸ',
    nav_products: 'ಪಶು ಉತ್ಪನ್ನಗಳು',
    nav_admin: 'ಅಡ್ಮಿನ್ ಪೋರ್ಟಲ್',
    nav_signin: 'ಸೈನ್ ಇನ್',
  ...
  bn: {
    ...
    nav_history: 'ইতিহাস',
    nav_products: 'পশু খাদ্য ও ওষুধ',
    nav_admin: 'এডমিন পোর্টাল',
    nav_signin: 'সাইন ইন',
