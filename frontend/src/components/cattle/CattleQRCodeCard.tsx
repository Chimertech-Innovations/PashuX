...
export default function CattleQRCodeCard({
  ...
  return (
    <div className="bg-white rounded-3xl p-4 sm:p-6 md:p-8 border border-slate-200 shadow-xl shadow-slate-200/50 mb-6 w-full max-w-full overflow-hidden">
      <div className="flex flex-col lg:flex-row gap-6 md:gap-8 items-center lg:items-start">
        ...
        <div className="flex flex-col items-center flex-shrink-0 w-full lg:w-auto">
          <div className="p-4 sm:p-5 bg-white border-2 border-emerald-500/20 rounded-3xl shadow-lg relative group transition-all duration-300 hover:shadow-emerald-500/10">
            <QRCodeCanvas
              id={`cattle-qr-${cattleId}`}
              value={profileUrl}
              size={200}
          ...
          <div className="mt-3 text-center flex flex-col items-center gap-1 w-full max-w-[240px]">
            <span className="inline-flex items-center gap-1.5 text-emerald-600 font-black text-[11px] bg-emerald-50 border border-emerald-200 px-3 py-1 rounded-full text-center">
        ...
        <div className="flex-1 w-full min-w-0 space-y-4">
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <h3 className="text-lg sm:text-xl font-black text-slate-900 truncate">Cattle Profile QR Code</h3>
            </div>
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-2xl p-3 sm:p-3.5 flex flex-wrap items-center justify-between gap-2">
            <div className="flex items-center gap-2.5 min-w-0">
              <div className="w-9 h-9 bg-white rounded-xl border border-slate-200 p-1 flex items-center justify-center shadow-sm flex-shrink-0">
                <img src="/chimertech_logo.png" alt="Chimertech Logo" className="w-full h-full object-contain" />
              </div>
              <div className="min-w-0">
                <p className="text-[9px] font-black text-slate-400 uppercase tracking-wider">QR Center Logo</p>
                <p className="text-xs font-black text-slate-800 truncate">Chimertech Official Logo</p>
              </div>
            </div>
            <a
              href={logoWebsiteUrl}
              target="_blank"
              rel="noopener noreferrer"
              className="text-xs font-bold text-emerald-600 hover:underline flex items-center gap-1 flex-shrink-0"
            >
              <span>chimertech.com</span>
          ...
          {/* Target URL Preview */}
          <div className="bg-slate-100 border border-slate-200 rounded-xl px-3 sm:px-3.5 py-2.5 flex flex-wrap items-center justify-between gap-2">
            ...
            <button
              onClick={copyLink}
              className="text-xs font-bold text-emerald-600 hover:text-emerald-700 px-2.5 py-1 bg-white rounded-lg border border-slate-200 shadow-sm flex-shrink-0 flex items-center gap-1.5"
            >
              {copied ? (
                <>
          ...
          <div className="flex flex-col sm:flex-row gap-2.5 pt-1">
            <button
              onClick={shareWhatsApp}
              className="flex-1 bg-emerald-600 hover:bg-emerald-700 active:bg-emerald-800 text-white font-black text-xs sm:text-sm py-3 px-4 rounded-2xl shadow-md shadow-emerald-600/20 flex items-center justify-center gap-2 transition-all transform hover:-translate-y-0.5"
            >
            ...
            <button
              onClick={downloadQR}
              className="flex-1 bg-slate-900 hover:bg-slate-800 text-white font-bold text-xs sm:text-sm py-3 px-4 rounded-2xl shadow-md flex items-center justify-center gap-2 transition-all transform hover:-translate-y-0.5"
            >
              <svg className="w-4 h-4 sm:w-5 sm:h-5 fill-none stroke-current flex-shrink-0" viewBox="0 0 24 24" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
              </svg>
